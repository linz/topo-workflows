...
| skip-tile-index-validate | str   | false                                                                                               | Skip the tile-index-validate step, which may fail for some imagery (such as tiles with sidecar .tfw or .prj files) which nonetheless may be able to be standardised successfully. |
