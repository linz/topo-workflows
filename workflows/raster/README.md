...
| producer_list          | str   |                                       | List of imagery producers, separated by semicolons (;). :warning: Has no effect unless a semicolon delimited list is entered.                                                                                         |
| licensor               | enum  | Unknown                               | Imagery licensor. :warning: Ignored if `licensor_list` is used.                                                                                                                                                       |
| licensor_list          | str   |                                       | List of imagery licensors, separated by semicolons (;). :warning: Has no effect unless a semicolon delimited list is entered.                                                                                         |
