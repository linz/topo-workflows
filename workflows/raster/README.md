...
# merge-national-hillshades

This workflow uses the tpl-merge-hillshade-layers workflow template to layer multiple hillshade datasets over each other. This way we back-fill gaps in the 1m hillshade using 8m hillshade data to create a consistent national dataset composed of 1:50k tiles.

Upon completion all standardised TIFF and STAC files will be located in the ./dem-`PRESET`/flat/ directory of the workflow in the artifacts scratch bucket, where `PRESET` stands for each hillshade preset that was processed (i.e. `hillshade` or `hillshade-igor`). In addition, a Basemaps link is produced enabling visual QA.
...
| ticket                  | str     |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | Ticket ID e.g. 'TDE-1130'                                                                                                                                                                                                                                         |
| hillshades              | json    | [{"preset": "hillshade", "top_layer": "s3://nz-elevation/new-zealand/new-zealand/dem-hillshade_1m/2193/", "base_layer": "s3://nz-elevation/new-zealand/new-zealand-contour/dem-hillshade_8m/2193/", "odr_url": "s3://nz-elevation/new-zealand/new-zealand/dem-hillshade/2193/"}, {"preset": "hillshade-igor", "top_layer": "s3://nz-elevation/new-zealand/new-zealand/dem-hillshade-igor_1m/2193/", "base_layer": "s3://nz-elevation/new-zealand/new-zealand-contour/dem-hillshade-igor_8m/2193/", "odr_url": "s3://nz-elevation/new-zealand/new-zealand/dem-hillshade-igor/2193/"}] | Preset name, top layer, base layer and ODR URL to pass to the merge workflow.                                                                                                                                                                                     |
| group                   | int     | 2                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | How many output tiles to process in each standardising task "pod". Change if you have resource or performance issues when standardising a dataset.                                                                                                                |
| publish_to_odr          | enum    | false                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Run [publish-odr](#Publish-odr) after standardising has completed successfully (`true` / `false`)                                                                                                                                                                 |
| copy_option             | enum    | --force-no-clobber                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Used only if `publish_to_odr` is true.<dl><dt>`--no-clobber` </dt><dd> Skip overwriting existing files.</dd><dt> `--force` </dt><dd> Overwrite all files. </dd><dt> `--force-no-clobber` </dt><dd> Overwrite only changed files, skip unchanged files. </dd></dl> |
| geospatial_category     | enum    | dem                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  | Geospatial category of the source dataset, e.g. `dem`. Will append hillshade preset name to pass to the merge workflow.                                                                                                                                           |
| create_capture_area     | enum    | true                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Create a GeoJSON capture area for the dataset.                                                                                                                                                                                                                    |
