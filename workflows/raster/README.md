...
- [Merge National Hillshades](#merge-national-hillshades)
- [tests](#Tests)
...
# merge-national-default-hillshades

# merge-national-igor-hillshades

These workflows use the tpl-merge-hillshade-layers workflow template to layer the 1m and 8m hillshade dataset of each respective hillshade preset over each other. This way we back-fill gaps in the 1m hillshade using 8m hillshade data to create a gap-less national dataset composed of 1:50k tiles.

Upon completion all standardised TIFF and STAC files will be located in the ./`PRESET`/flat/ directory of the workflow in the artifacts scratch bucket, where `PRESET` stands for each hillshade preset that was processed (i.e. `dem-hillshade` or `dem-hillshade-igor`). In addition, a Basemaps link is produced enabling visual QA.
...
| ticket                  | str     |                                                                                                                                                               | Ticket ID e.g. 'TDE-1130'                                                                                                                                                                                                                                         |
| top_layer_source        | str     | `s3://nz-elevation/new-zealand/new-zealand/dem-hillshade_1m/2193/` or `s3://nz-elevation/new-zealand/new-zealand/dem-hillshade-igor_1m/2193/`                 | Top layer (1m hillshade) to add.                                                                                                                                                                                                                                  |
| base_layer_source       | str     | `s3://nz-elevation/new-zealand/new-zealand-contour/dem-hillshade_8m/2193/` or `s3://nz-elevation/new-zealand/new-zealand-contour/dem-hillshade-igor_8m/2193/` | Base layer (8m hillshade) to use.                                                                                                                                                                                                                                 |
| odr_url                 | str     | `s3://nz-elevation/new-zealand/new-zealand/dem-hillshade/2193/` or `s3://nz-elevation/new-zealand/new-zealand/dem-hillshade-igor/2193/`                       | S3 path to the existing dataset to load existing metadata.                                                                                                                                                                                                        |
...
| copy_option             | enum    | --force-no-clobber                                                                                                                                            | Used only if `publish_to_odr` is true.<dl><dt>`--no-clobber` </dt><dd> Skip overwriting existing files.</dd><dt> `--force` </dt><dd> Overwrite all files. </dd><dt> `--force-no-clobber` </dt><dd> Overwrite only changed files, skip unchanged files. </dd></dl> |
| geospatial_category     | enum    | `dem-hillshade` or `dem-hillshade-igor`                                                                                                                       | Geospatial category of the hillshade dataset.                                                                                                                                                                                                                     |
| create_capture_area     | enum    | true                                                                                                                                                          | Create a GeoJSON capture area for the dataset.                                                                                                                                                                                                                    |
