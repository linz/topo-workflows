...
| **Container**                                                                             | **Purpose**                                                                       |
| ----------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| [geoprocessor](https://github.com/linz/geoprocessor/pkgs/container/geoprocessor%2Fraster) | Python scripts that need to use the GDAL library and geospatial Python libraries. |
...
spec:
  ...
  templates:
    ...
    - name: say-hello-template
      container:
        image: '019359803926.dkr.ecr.ap-southeast-2.amazonaws.com/geoprocessor/raster:v10'
        command: [echo]
        args: ['hello world']
```
